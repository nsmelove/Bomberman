...
var view;
(function (view) {
    var CoinText = (function (_super) {
        __extends(CoinText, _super);
        function CoinText(value, x, y) {
            if (x === void 0) { x = 0; }
            if (y === void 0) { y = 0; }
        ...
        CoinText.prototype.setValue = function (value) {
        ...
        CoinText.prototype.recycle = function (delay) {
...
//# sourceMappingURL=CoinText.js.map